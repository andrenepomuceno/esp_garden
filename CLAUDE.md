...
- **`history.records` is capped in RECORDS, so the cap comes down whenever the record grows** — 6000 → 5000 at 48 bytes, then 5000 → **2500** under LittleFS, because 240 KB no longer fits in the 189 KB free before any history exists.
